...
public class Promoter_Favorite_Coupon_Task extends AsyncTask<String, Void , String> {
    ...
    public Promoter_Favorite_Coupon_Task(Context context,String coupon_id ,String action){
    ...
    protected void onPreExecute() {
	  ...
	  protected String doInBackground(String... urls) {
	   ...
	   try {			   
		 ...
		 httppost = new HttpPost(CommonUtil.URL+CommonUtil.Method_PromoterFavoriteCoupon);
		 ...
		 mpEntity.addPart("action", new StringBody(action));
...
//		  Common.showalertDialog(mContext, result);
				try {
					...
					{						
					  Common.showalertDialog(mContext, mContext.getResources().getString(R.string.toast_add_favoritecoupon));
 					
					}else if (!jobj_status.getBoolean("success")) {
						
					 Common.showalertDialog(mContext, mContext.getResources().getString(R.string.toast_notadd_favoritecoupon));
