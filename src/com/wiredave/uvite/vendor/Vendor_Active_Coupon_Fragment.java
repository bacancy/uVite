...
public class Vendor_Active_Coupon_Fragment extends Fragment implements OnClickListener{

	View view = null;
	public static TextView txt_total_coupon, txt_total_referred,
			txt_total_redeemed;
	public static ListView list_vendor_active;
	public static Vendor_Active_Coupon_Adapter vendor_active_coupon_adapter;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.vendor_active_expired_redeemed_coupon,
				container, false);
		...
		Vendor_Coupon_Listing.rl_active_coupon
				.setBackgroundResource(R.color.selected_tab);
		Vendor_Coupon_Listing.rl_expired_coupon
				.setBackgroundResource(R.color.unselected_tab);
		Vendor_Coupon_Listing.rl_redeemed_payment
				.setBackgroundResource(R.color.unselected_tab);
		...
		if (Common.isConnectingToInternet(getActivity())) {
			...
			new Get_Vendor_All_Coupon_Task(getActivity(), "active").execute();
		} else {
	...
	public void initialization() {
		...
		txt_total_referred = (TextView) view
				.findViewById(R.id.txt_total_referred);
		txt_total_redeemed = (TextView) view
				.findViewById(R.id.txt_total_redeemed);

		list_vendor_active = (ListView) view
				.findViewById(R.id.list_vendor_active_expired_redeemed);
