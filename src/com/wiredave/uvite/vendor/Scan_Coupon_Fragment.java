...
public class Scan_Coupon_Fragment extends Fragment implements OnClickListener{
	
	View view = null;
	Button btn_scan_qrcode,btn_coupon_id;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.scan_coupon_fragment, container, false);
		...
		Home_Screen.txt_header.setText(getResources().getString(R.string.scan_coupon));
		...
		btn_coupon_id.setOnClickListener(this);		
	...
	public void initialization()
	{
		...
		btn_scan_qrcode = (Button)view.findViewById(R.id.btn_scan_qrcode);
		btn_coupon_id = (Button)view.findViewById(R.id.btn_coupon_id);
	...
	public void onClick(View v) {
		...
		if(v.getId() == R.id.btn_scan_qrcode)
		{
		    getActivity().startActivity(new Intent(getActivity(),Vendor_Scan_QR.class));
			getActivity().overridePendingTransition(0, 0);
			 
		}else if (v.getId() == R.id.btn_coupon_id) {
		...
		}else if(v.getId() == R.id.rl_edit_account)
		{
			...
			/*Home_Screen.fragmentManager = getFragmentManager();
			FragmentTransaction fragmentTransaction = Home_Screen.fragmentManager
					.beginTransaction();
			fragmentTransaction.add(R.id.rl_scancoupon,
