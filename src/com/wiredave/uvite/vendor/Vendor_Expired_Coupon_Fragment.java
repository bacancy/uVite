...
public class Vendor_Expired_Coupon_Fragment extends Fragment implements OnClickListener{

	View view = null;
	public static TextView txt_total_coupon,txt_total_referred,txt_total_redeemed;
	public static ListView list_vendor_expired;
	...
	public static Vendor_Expired_Coupon_Adapter vendor_expired_coupon_adapter;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		Vendor_Coupon_Listing.rl_expired_coupon.setBackgroundResource(R.color.selected_tab);
		Vendor_Coupon_Listing.rl_redeemed_payment.setBackgroundResource(R.color.unselected_tab);
			
		 //check internet connetivity...
		 if(Common.isConnectingToInternet(getActivity()))
		 {
			 //get vendor all active coupons...
			 new Get_Vendor_All_Coupon_Task(getActivity(), "expired").execute(); 
		  }else {		
			 Common.showalertDialog(getActivity(), getActivity().getResources().getString(R.string.alert_internetconnectivity));
		 }
		/*vendor_expired_coupon_adapter = new Vendor_Expired_Coupon_Adapter(getActivity(), R.layout.custom_vendorcoupon_list, CommonUtil.vendor_expired_coupon_array);
		list_vendor_expired.setAdapter(vendor_expired_coupon_adapter);*/
	...
	{				
		...
		list_vendor_expired = (ListView)view.findViewById(R.id.list_vendor_active_expired_redeemed);
	}
