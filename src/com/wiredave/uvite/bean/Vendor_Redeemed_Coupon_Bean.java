...
public class Vendor_Redeemed_Coupon_Bean implements Serializable{

	String coupon_id,vendor_id,coupon_title,coupon_description,coupon_category,discount_type,
    availability,start_date,end_date,commission,logo,total_coupon,total_amount,coupon_code,qrcode_image,
    coupon_referred,coupon_used,status,created_date;
